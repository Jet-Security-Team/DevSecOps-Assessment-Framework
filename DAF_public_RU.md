...
> | T-ADI-DEP-1-4 | Выполняется харденинг (безопасная настройка) файлов конфигураций используемых пакетов OSS (Open Source Software). </br>Например, nuget.config, .npmrc, pip.conf, pom.xml, etc. | 2 | - | 83, 91, 56 | EM-A-1 | - | - | CNFG1 |
...
> | T-ADI-DEP-3-2 | При выполнении запросов на слияние (PR/MR) предоставляется список всех уязвимостей используемых зависимостей.</br>Это может быть реализовано с помощью SCA решения. | 4 | - | - | - | 7.4.3.7 Табл. 5 - Анализ коммерческих и открытых программных модулей на наличие уязвимостей | - | - |
...
> | T-ADI-ART-4-3 | Выполняется создание цифровых подписей артефактов после проверок безопасности и перед их отправкой в доверенный registry. | 5 | SE2.4 | - | - | - | - | SCS1, IA3 |
...
> | T-DEV-COMP-1-2 | Удаленный доступ с некорпоративных и, как следствие, ненастроенных устройств к инструментам разработки возможен только для ограниченного (небольшого) числа устройств. | 1 | - | - | - | 7.4.3.2 | - | AC2, MI1 |
...
> | T-DEV-BLD-1-1 | Доступ к среде сборки (build) (оркестратор, worker-узлы и т.д.) ограничен (настроен RBAC). | 2 | - | 57, 58 | - | 7.4.3.2 | 5.13.2.7 | AC2, MI1 |
...
> | T-DEV-SCM-3-4 | Доступ к SCM осуществляется только с разрешенных IP-адресов. | 4 | - | - | - | 7.4.3.3 | - | AC1 |
> | T-DEV-SCM-4-1 | Проводится анализ кода на наличие аномалий, релевантных организации (например, commit содержит слишком значительные изменения объемов кода или commit'ов слишком много в определенный промежуток времени). | 6 | - | - | - | 7.4.3.3 | - | MI4 |
> | T-DEV-SCM-4-2 | Доступ разработчиков к репозиторию осуществляется с применением сертификатов, созданных только на основе внутреннего CA (центр сертификации) компании (а не самоподписанные сертификаты) в качестве дополнительного фактора аутентификации. | 6 | - | - | - | 7.4.3.3 | - | - |
> | T-DEV-SCM-4-3 | Автоматизированный харденинг настроек проектов в SCM через API или dev. platform eng. с сравнением состояния. | 6 | - | - | - | - | - | - |
> </details>
...
> | T-DEV-SRC-2-2 | Запрос на слияние (PR/MR) реализуется только при успешном прохождении всех проверок. | 3 | ST3.6 | 68 | - | - | - | - |
> | T-DEV-SRC-2-3 | Все открытые ветки (branches) обновляются перед отправкой запросов на слияние. | 3 | - | - | - | - | - | - |
...
> | T-DEV-SRC-2-5 | Запрос на слияние осуществляется только при условии привязки соответствующей задачи на разработку (task, тикет) в системе управления задачами (task maganement system). | 3 | - | - | - | - | - | - |
...
> | T-DEV-SRC-3-3 | Только подписанные commits (signed commit) допускаются к запросам на слияние (MR/PR) (особенно в main-ветку). | 4 | SE2.4 | - | - | 7.4.3.7 Табл. 5 - Обеспечение контроля целостности всего программного кода и размещение доступных механизмов для контроля в соответствующих средах | 5.14.2.3 | - |
> | T-DEV-SRC-3-4 | Каждое изменение в исходном коде (запрос на слияние (MR/PR)) согласовывается как минимум двумя аутентифицированными пользователями. | 4 | - | - | - | 7.4.2.1,, 7.4.3.7 | - | - |
> | T-DEV-SRC-3-5 | Осуществляется контроль за удалением защищенных веток (protected branch). | 4 | - | - | - | - | - | - |
> | T-DEV-SRC-3-6 | Осуществляется контроль за тем, как сканеры безопасности (SAST,SCA,Secrets) игнорируют "skip/ignore scan" inline комментарии и ignore файлы (.aiignore, .gitleaksignore и т.д.). | 4 | - | 68 | - | - | - | - |
...
> | T-DEV-CICD-4-1 | Каждый пайплайн имеет единственное предназначение (например, тестирование, компиляция, отправка артефактов), прочие задачи на нем не выполняются. | 5 | - | - | - | - | - | TP3 |
> </details>
...
> | T-CODE-SPC-1-2 | При выборе подрядчика, осуществляющего заказную разработку, учитываются его возможности, опыт, существующие у подрядчика мероприятия, связанные с безопасной разработкой ПО. | 2 | - | - | - | 7.4.3.6 Табл. 4 Проверка соответствия требованиям ИБ стороннего программного обеспечения | - | - |
...
> | T-CODE-SPC-4-1 | Вся заказная разработка ПО ведется подрядчиками (разработчиками ПО) в инфраструктуре компании-заказчика, с использованием всех инструментов безопасной разработки (SAST, DAST, OSA\SCA, Container security и др.) и в соответствии с процессами компании-заказчика. | 7 | - | - | - | - | - | - |
> </details>
...
> | T-CODE-SST-2-1 | Выполняется регулярное сканирование отдельных частей кода, например:</br>- изменений в коде по результатам спринтов</br>- код разработанных framework</br>- и т.д. | 3 | - | 174, 175, 176 | ST-A-2 | 7.4.3.7 Табл. 5 - Статический анализ кода на уязвимости ИБ | 5.10.2.4 | QA5 |
> | T-CODE-SST-2-2 | Неиспользуемые правила анализа в SAST отключены. | 3 | - | - | ST-A-2 | - | 5.10.2.3 | SPA4 |
> | T-CODE-SST-2-3 | Выполнена интеграция SAST в CI (отдельный скрипт для каждой команды). | 3 | CR1.4, CR1.5 | - | ST-A-3 | - | - | SPA5 |
...
> |ID| Описание | Уровень Кирилламиды | BSIMM | DSOMM | SAMM | ПЗ ЦБ | ГОСТ Р 56939 | AppSec Table Top | 
> | --- | --- | --- | --- | --- | --- | --- | --- | --- |
> | T-CODE-SC-0-1 | Выполняется композиционный анализ разрабатываемого ПО. | 0 | - | 171, 172, 178 | SB-B-2 | 7.4.3.7 Табл. 5 - Анализ коммерческих и открытых программных модулей на наличие уязвимостей | 5.16.2.4 | OSS1, SCA1 |
...
> | T-CODE-SC-2-4 | Настроена интеграция SCA в CI/CD. | 2 | CR1.4, CR1.5 | - | ST-A-3 | - | - | SCA1, SCA3 |
...
> | T-CODE-SC-3-2 | Совмещение практик SAST и SCA для идентификации уязвимостей в коде (effective usage analysis. Например, библиотека уязвима, но при этом НЕ используется уязвимый метод). | 4 | CR3.2 | 161 | - | - | - | - |
...
> | T-CODE-IMG-2-1 | Выполняется сканирование образов контейнеров в CI/CD на наличие уязвимостей. | 2 | - | - | - | 7.4.3.7 Табл. 5 - Анализ коммерческих и открытых программных модулей на наличие уязвимостей | 5.16.2.4 | - |
...
> | T-PREPROD-VULN-2-2 | Выполняется регулярное выполнение задач инвентаризации активов PREPROD (среды тестирования и разработки ПО) сред автоматизированными средствами. | 4 | SM3.1 | - | - | 7.4.2.1 | - | - |
> | T-PREPROD-VULN-2-3 | Обновления безопасности регулярно устанавливаются на основные элементы  инфраструктуры PREPROD (среды тестирования и разработки ПО).</br>Например, оркестратор и операционные системы серверов. | 4 | - | - | EM-B-3 | 7.4.2.1,, 7.4.3.3 | - | CNFG1 |
...
> | T-PREPROD-VULN-3-4 | Обновления безопасности регулярно устанавливаются на все элементы инфраструктуры PREPROD (среды тестирования и разработки ПО).</br>Например, оркестратор и операционные системы серверов. | 5 | - | - | - | 7.4.2.1,, 7.4.3.3 | - | - |
...
> <details>
> <summary>Контроль выполняемых файлов, процессов и их прав доступа [T-PROD-RUN]</summary>
>
> |ID| Описание | Уровень Кирилламиды | BSIMM | DSOMM | SAMM | ПЗ ЦБ | ГОСТ Р 56939 | AppSec Table Top | 
> | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
> | T-PROD-VULN-2-2 | Выполняется регулярное выполнение задач инвентаризации активов PROD автоматизированными средствами. | 2 | SM3.1, CMVM2.3 | - | - | 7.4.2.1 | - | - |
...
> | P-EDU-AWR-3-1 | В Компании внедрена и работает программа поощрения внутреннего обмена опытом. | 5 | - | 49 | EG-B-3 | - | - | ET2, TAS2 |
...
> | P-EDU-KB-2-1 | Существует централизованный ресурс (общая база знаний), хранящий базовые правила и рекомендации по безопасной разработке. | 3 | SR1.1, SR1.2 | - | - | - | - | SP1 |
...
> | P-EDU-KB-3-1 | Централизованный ресурс (общая база знаний), хранит единые детальные правила и рекомендации по безопасной разработке, относящиеся, как к компании в целом, так и к отдельным командам разработки. | 4 | SR1.2 | - | - | - | - | SC2 |
> | P-EDU-KB-3-2 | Единая база знаний обновляется регулярно, назначены ответственные за ее обновление как внутри команд, так и в компании, выполняется QA созданных материалов в базе знаний. | 4 | SR1.2 | - | - | - | - | SP2 |
> | P-EDU-KB-3-3 | База знаний наполняется реальными примерами и сложными кейсами, которые были найдены на пентестах, багбаунти, в результате триажа AppSec`ами (например нарушения бизнес-логики). | 4 | - | - | - | - | - | - |
...
> | P-REQ-TM-3-2 | Процесс моделирования угроз для разрабатываемого ПО стандартизован (есть шаблоны МУиМН, определены подходы к актуализации угроз и пр). | 4 | AA2.1 | 30 | TA-B-2 | - | - | - |
...
> | P-REQ-RD-3-3 | Ключевые решения, которые влияют на уровень ИБ разрабатываемого приложения, принимаются на архитектурном комитете. | 4 | - | - | - | - | - | TP4 |
...
> | P-REQ-CR-1-1 | Требования ИБ к разрабатываемому ПО проверяются на этапе выпуска ПО в продуктовую среду. | 1 | SM1.4 | 151 | SB-A-3 | 7.4.3.9 Табл. 7 Проверка соответствия выполнения требований ИБ проектной и эксплуатационной документации | - | VC2, ISA2 |
> | P-REQ-CR-2-1 | Осуществляется контроль выполнения требований ИБ к разрабатываемому ПО посредством функциональных тестирований ИБ и тестирований на проникновение. | 2 | SM1.4, ST1.3 | 148 | RT-B-2, ST-B-2 | 7.4.3.8 Табл. 6 Функциональное тестирование  ФБО,, 7.4.3.8 Табл. 6 Проведение тестов по безопасности | - | VC2, ISA2 |
...
> | P-REQ-STDR-App-3-1 | Стандарты конфигурирования разработаны и применяются для всех систем. | 5 | - | - | EM-A-2 | - | - | CNFG1 |
> | P-REQ-STDR-App-3-2 | Используется подход IaC для контроля конфигурации разрабатываемого ПО. | 5 | - | - | - | - | - | - |
...
> | P-DEFECT-MNG-3-1 | Для каждого дефекта ИБ создается задача (task, тикет) в системе управления задачами (task maganement system). Осуществляется контроль устранения дефекта (выполнения задачи). | 3 | PT1.2, CMVM1.3, CMVM3.1 | - | DM-A-2 | - | 5.5.2.5 | VM1 |
...
> | P-DEFECT-CNS-3-2 | Отчеты загружаются в SGRC в ручном режиме. | 5 | CR2.8 | - | - | - | - | - |
...
> | P-MET-EX-3-3 | Выполняется визуализация результатов сбора метрик процессов DSO (формирование дашбордов. Например, в Grafana). | 4 | - | - | - | - | - | - |
